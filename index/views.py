...
def gerar_banco(request):
    if cadastroFuncionario.objects.all():
...
def gerarFuncionariosBloqueados(request):
    ...
    for nome in nomes:
        ...
        new_funcionario = cadastroFuncionario(
            ...
            cpf_funcionario = nome[1],
            sispat_funcionario = nome[2],
            disponibilidade_funcionario = False,
        )
        new_funcionario.save()
...
def index(request):
    context={
        ...
        'gerar_banco':gerar_banco,
        'limparBanco':limparBanco,
        'limparCertificado':limparCertificado,
    }
    return render(request, 'index/inicial.html', context)